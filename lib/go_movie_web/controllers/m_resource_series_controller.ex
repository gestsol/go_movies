defmodule GoMovieWeb.MResourceSerieController do
  ...
  def update_chapter(conn, %{"chapter" => chapter, "serie_id" => serie_id, "season_id" => season_id, "chapter_id" => chapter_id}) do
  ...
  def delete_chapter(conn, %{"serie_id" => serie_id, "season_id" => season_id, "chapter_id" => chapter_id}) do
